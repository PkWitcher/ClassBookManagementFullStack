...
export default function Home() {
  ...
  return (
    <div className="no-scroll-container" style={{
      ...
      <section style={{
        ...
        <div style={{ color: '#ecf0f1' }}>
          <h1 style={{ fontSize: '2.5rem', margin: 0 }}>{isAdmin ? 'Manage Amazing Classes & Sessions' : 'Discover and Book Amazing Classes'}</h1>
        ...
        <div>
          <img
            ...
            onMouseEnter={(e) => {
              ...
              (e.currentTarget as HTMLImageElement).style.boxShadow = '0 14px 36px rgba(0,0,0,0.45)';
            }}
            onMouseLeave={(e) => {
              (e.currentTarget as HTMLImageElement).style.transform = 'scale(1)';
              (e.currentTarget as HTMLImageElement).style.boxShadow = '0 10px 30px rgba(0,0,0,0.35)';
            }}
          />
        </div>
      </section>
      ...
      <section style={{
        ...
        <div style={{
          ...
          <h2 style={{ textAlign: 'center', margin: '0 0 1rem 0', color: '#2c3e50' }}>Why ClassBook?</h2>
          <div style={{
            display: 'grid',
            ...
            {cards.map((card) => (
              ...
              >
                ...
                <div style={{ padding: '1rem', flex: '1', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                  <h3 style={{ margin: '0 0 0.5rem 0', color: '#2c3e50' }}>{card.title}</h3>
...
function getRoleBasedContent(isAdmin: boolean, isLoggedIn: boolean) {
  ...
  if (!isLoggedIn) {
    return {
      heroImage: images[0],
      cards: [
        { title: 'Curated Classes', desc: 'Hand-picked topics across tech, wellness, arts and more.', img: images[2] },
        { title: 'Live Sessions', desc: 'Join interactive sessions and learn with peers and mentors.', img: images[1] },
        { title: 'Easy Bookings', desc: 'Book, manage and cancel with friendly UI.', img: images[3] },
      ],
    };
  }
  ...
  if (isAdmin) {
    return {
      heroImage: images[1],
      cards: [
        { title: 'Create Powerful Classes', desc: 'Design and publish classes your learners will love.', img: images[3] },
        { title: 'Schedule Sessions', desc: 'Plan sessions with perfect capacity and time.', img: images[0] },
        { title: 'Manage Bookings', desc: 'View, audit and cancel bookings with one click.', img: images[2] },
      ],
    };
  }
  ...
  return {
    heroImage: images[2],
    cards: [
      { title: 'Curated Classes', desc: 'Hand-picked topics across tech, wellness, arts and more.', img: images[0] },
      { title: 'Live Sessions', desc: 'Interactive learning with peers and mentors.', img: images[3] },
      { title: 'Easy Bookings', desc: 'Book, manage and cancel in a click.', img: images[1] },
    ],
  };
}
